  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Sort data based on the monthOrder
      ...
      <Card bordered={false} style={{ backgroundColor: 'rgba(254, 118, 118, 0.1)', borderRadius: '8px', padding: '20px' }}>
        ...
        <ResponsiveContainer width="100%" height={350}>
          <LineChart data={lineData}>
            ...
            <Line type="monotone" dataKey="totalCubes" stroke="url(#sandGradient)" strokeWidth={4} dot={{ stroke: 'url(#sandDotGradient)', strokeWidth: 3, r: 6 }} activeDot={{ stroke: 'url(#sandDotGradient)', strokeWidth: 4, r: 8 }} animationDuration={1000} />
            <defs>
...
MonthlyChart.propTypes = {
  lineData: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      totalCubes: PropTypes.number.isRequired,
    })
  ),
};
