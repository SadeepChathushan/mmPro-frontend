...
import officerService from "../../services/officerService"; // Import the service
...
const History = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const data = await officerService.fetchDispatchHistoryData(apiKey); // Call the service function
