...
const MiningEngineerRegister = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
          const result = await authService.registerUser(formData, "mining_engineer");
  ...
  return (
    ...
    <Row justify="center">
      <Col xs={24} sm={22} md={20} lg={18} xl={16}>
        <Card
          title={<Title level={3} style={{ textAlign: "center" }}>Create New Account</Title>}
          bordered={false}
          ...
          >
            ...
            <Row gutter={16}>
              <Col xs={24} md={8}>
                ...
                >
                  <Upload {...createUploadProps(nicFrontFile, setNicFrontFile)}>
