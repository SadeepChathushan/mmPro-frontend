...
const Dashboard = () => {
    ...
    const handleCheck = () => {
        ...
        if (validVehicle) {
            ...
            setModalMessage(language === 'en' ? 'Invalid Load' : 'අනවසර පැටවීමක්');
            setIsModalOpen(true);
        }
    };
                    ...
                    <div style={styles.modalContent}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <button
                                ...
                                onClick={handleReport} // Submit complaint when clicked
                            >
